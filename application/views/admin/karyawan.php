        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7"> 
              <h6 class="h2 text-white d-inline-block mb-0">Kelola Karyawan</h6>
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="#" data-toggle="modal" data-target="#exampleModal" class="btn btn-sm btn-neutral">Tambah Karyawan</a> 
            </div>
          </div>
        </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <input type="hidden" required name="id_x"  value="<?=$row->id_karyawan?>"> 
            ...
            <div class="form-group">
                <label for="example-email-input" class="form-control-label">ID Karyawan</label>
                <input class="form-control" type="text" required name="id" value="<?=$row->id_karyawan?>">
            </div> 
            <div class="form-group">
                <label for="example-email-input" class="form-control-label">Nama</label>
            ...
            <div class="form-group">
                <label for="example-email-input" class="form-control-label">Jenis Kelamin</label>
                <div class="custom-control custom-radio mb-3">
                        <input class="custom-control-input" name="jk" value="Laki - Laki" id="customRadio5-<?=$row->id_karyawan?>" <?php if ($row->jk == 'Laki - Laki') { echo "checked";    } ?> type="radio">
                        <label class="custom-control-label" for="customRadio5-<?=$row->id_karyawan?>">Laki - Laki</label>
                      </div>
                      <div class="custom-control custom-radio mb-3">
                        <input class="custom-control-input" name="jk" value="Perempuan" id="customRadio6-<?=$row->id_karyawan?>" <?php if ($row->jk == 'Perempuan') { echo "checked";    } ?>  type="radio">
                        <label class="custom-control-label" for="customRadio6-<?=$row->id_karyawan?>">Perempuan</label>
                      </div>
            </div>  
        ...
        <div class="modal-content bg-gradient-danger"> 
                  ...
                  <div class="modal-body">
                      ...
                      <div class="py-3 text-center">
                          ...
                          <h4 class="heading mt-4"> Hapus Data Karyawan ini? </h4> 
                      </div>
