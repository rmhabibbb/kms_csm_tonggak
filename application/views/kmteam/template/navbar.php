      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav align-items-center  ml-auto ml-md-0 ">
           <li class="nav-item ">
              <a class="nav-link pr-0" href="<?=base_url('kmteam/')?>" >
            ...
            <li class="nav-item ">
              <a class="nav-link pr-0" href="<?=base_url('kmteam/diskusi')?>" >
                <div class="media align-items-center"> 
                  <div class="media-body  ml-2  d-none d-lg-block">
            ...
            <li class="nav-item ">
              <a class="nav-link pr-0" href="<?=base_url('kmteam/knowledge')?>" >
                <div class="media align-items-center"> 
                  <div class="media-body  ml-2  d-none d-lg-block">
                    <span class="mb-0 text-sm  font-weight-bold">Pengajuan Knowledge</span>
                  </div>
                </div>
              </a> 
            </li>
            <li class="nav-item ">
              <a class="nav-link pr-0" href="<?=base_url('kmteam/kategori')?>" >
                <div class="media align-items-center"> 
                  <div class="media-body  ml-2  d-none d-lg-block">
                    <span class="mb-0 text-sm  font-weight-bold">Kelola Kategori</span>
                  </div>
                </div>
              </a> 
            </li>
            <li class="nav-item ">
              <a class="nav-link pr-0" href="<?=base_url('kmteam/profile')?>" >
                <div class="media align-items-center"> 
                  <div class="media-body  ml-2  d-none d-lg-block">
