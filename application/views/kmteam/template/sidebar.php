    ...
    <div class="scrollbar-inner">
      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link <?php if($index == 1){ echo 'active'; } ?>" href="<?=base_url('kmteam/')?>">
                <i class="ni ni-books text-black"></i>
                <span class="nav-link-text">Library Knowledge</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link <?php if($index == 2){ echo 'active'; } ?>" href="<?=base_url('kmteam/diskusi')?>">
            ...
            <li class="nav-item">
              <a class="nav-link <?php if($index == 3){ echo 'active'; } ?>" href="<?=base_url('kmteam/knowledge')?>">
                <i class="ni ni-book-bookmark text-black"></i>
                <span class="nav-link-text">Pengajuan Knowledge</span>
              </a>
            </li>  

            <li class="nav-item">
              <a class="nav-link <?php if($index == 4){ echo 'active'; } ?>" href="<?=base_url('kmteam/kategori')?>">
             ...
             <li class="nav-item">
              <a class="nav-link <?php if($index == 5){ echo 'active'; } ?>" href="<?=base_url('kmteam/profile')?>"  >
