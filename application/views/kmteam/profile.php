        ...
        <div class="col-xl-7 order-xl-1">
          ...
          <div class="card"> 
            <div class="card-body">
              ...
              <form action="<?=base_url('kmteam/profile/')?>" method="POST" id="formprofile">
                <div class="pl-lg-4">
                  <div class="row">
                    ...
                    <div class="col-lg-12">
                      <div class="form-group">
                        <div class="form-group">
                          ...
                          <input class="form-control" type="text" readonly name="id" value="<?=$kar->id_kmteam?>">
                      </div> 
                      ...
                      <div class="form-group">
                          ...
                          <div class="custom-control custom-radio mb-3">
                                  <input class="custom-control-input" name="jk" value="Laki - Laki" id="customRadio5-<?=$kar->id_kmteam?>" <?php if ($kar->jk == 'Laki - Laki') { echo "checked";    } ?> type="radio">
                                  <label class="custom-control-label" for="customRadio5-<?=$kar->id_kmteam?>">Laki - Laki</label>
                                </div>
                                <div class="custom-control custom-radio mb-3">
                                  <input class="custom-control-input" name="jk" value="Perempuan" id="customRadio6-<?=$kar->id_kmteam?>" <?php if ($kar->jk == 'Perempuan') { echo "checked";    } ?>  type="radio">
                                  <label class="custom-control-label" for="customRadio6-<?=$kar->id_kmteam?>">Perempuan</label>
                                </div>
                      </div>  
...
<div class="modal fade" id="edit-pw" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form action="<?=base_url('kmteam/profile/')?>" method="POST" id="formgpw">
