      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav align-items-center  ml-auto ml-md-0 ">
            ...
            <li class="nav-item ">
              <a class="nav-link pr-0" href="<?=base_url('pimpinan/')?>" >
                <div class="media align-items-center"> 
                  <div class="media-body  ml-2  d-none d-lg-block">
                    <span class="mb-0 text-sm  font-weight-bold">Verifikasi Knowledge</span>
                  </div>
                </div>
              </a> 
            </li>
           <li class="nav-item ">
              <a class="nav-link pr-0" href="<?=base_url('pimpinan/knowledge')?>" >
                <div class="media align-items-center"> 
                  <div class="media-body  ml-2  d-none d-lg-block">
            ...
            <li class="nav-item ">
              <a class="nav-link pr-0" href="<?=base_url('pimpinan/diskusi')?>" >
                <div class="media align-items-center"> 
                  <div class="media-body  ml-2  d-none d-lg-block">
            ...
            <li class="nav-item ">
              <a class="nav-link pr-0" href="<?=base_url('pimpinan/profile')?>" >
                <div class="media align-items-center"> 
                  <div class="media-body  ml-2  d-none d-lg-block">
