    ...
    <div class="scrollbar-inner">
      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link <?php if($index == 1){ echo 'active'; } ?>" href="<?=base_url('karyawan/')?>">
                <i class="ni ni-books text-black"></i>
                <span class="nav-link-text">Library Knowledge</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link <?php if($index == 2){ echo 'active'; } ?>" href="<?=base_url('karyawan/diskusi')?>">
                <i class="ni ni-chat-round text-blue"></i>
                <span class="nav-link-text">Forum Diskusi</span>
              </a>
            </li>  
             <li class="nav-item">
              <a class="nav-link <?php if($index == 5){ echo 'active'; } ?>" href="<?=base_url('karyawan/profile')?>"  >
